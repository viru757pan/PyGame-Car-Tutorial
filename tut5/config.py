...
# outline_TRACK_BORDER_MASK = TRACK_BORDER_MASK.outline()
...
def create_track_border_polygon():
...
def getWidthHeight():
    width, height = RED_CAR.get_width(), RED_CAR.get_height()
    return width, height


# TRACK_BORDER_POLYGON = create_track_border_polygon()
